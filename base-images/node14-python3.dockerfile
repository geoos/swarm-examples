# docker build -f node14-python3.dockerfile -t docker.homejota.net/geoos/node14-python3:latest -t docker.homejota.net/geoos/node14-python3:0.9 .
# docker push docker.homejota.net/geoos/node14-python3:latest
